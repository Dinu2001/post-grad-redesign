  ...
  return (
    <>
      <button
        ...
        className="fixed left-4 top-4 z-40 flex h-10 w-10 items-center justify-center rounded-xl border border-border bg-white text-neutral-700 shadow-sm transition hover:bg-muted md:hidden"
      >
    ...
    <aside className={`bg-hero-gradient fixed inset-y-0 left-0 z-40 flex h-screen w-72 shrink-0 flex-col overflow-hidden text-white transition-transform duration-300 ease-out md:sticky md:top-0 md:h-screen md:w-64 md:translate-x-0 ${mobileOpen ? "translate-x-0" : "-translate-x-full"}`}>
